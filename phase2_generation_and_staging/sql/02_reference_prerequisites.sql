/*
  ...
  decisions. This file is OPTIONAL in Phase 2 because raw staging has no FKs
  to these tables. Run it only if the finalized OLTP tables already exist and
  the authoritative OLTP DDL did not already seed Role and Character.
